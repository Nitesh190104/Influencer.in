        ...
        <div className="dashboard-container influencer">
            ...
            <div className="dashboard-sidebar">
                ...
                <nav className="sidebar-nav">
                    <a href="/influencer-dashboard" className="nav-item">
                    ...
                    <a href="/influencer/settings" className="nav-item active">
            ...
            <div className="dashboard-main">
                <div className="settings-container">
                    ...
                    <form onSubmit={handleSubmit} className="settings-form">
                        ...
                        <div className="settings-section">
                            <h2>Avatar Icon</h2>
                            <p className="section-description">Choose an icon for your profile</p>
